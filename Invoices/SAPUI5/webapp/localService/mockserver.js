...
sap.ui.define([
    ...
    function (MockServer, JSONModel, UriParameters, Log) {
        ...
        var oMockServerInterface = {
             ...
             * @returns {Promise} a promise that is rsolved when the mock server has been started
             */
            init: function (oOptionsParameter) {
                ...
                return new Promise(function (fnResolve, fnReject) {
                    ...
                    oManifestModel.attachRequestCompleted(function () {
                        ...
                        //parse manifest fo local metadata URI
                        ...
                        //configure mock serer with the given options or a default delay of 0.5s        
                            MockServer.config({
                            autoRespond: true,
                        ...
                        var fnResponse = function (iErrCode, sMessage, aRequest) {
                            aRequest.response = function (oXhr) {
                                oXhr.respond(iErrCode, { "Content-Type": "text/plain;charset=utf8" }, sMessage);
                            };
                        };
                        ...
                        oMockServer.start();
                        Log.info("Running the app witch mock data");
                        fnResolve();
                    });
